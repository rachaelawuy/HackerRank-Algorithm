//Problem at https://www.hackerrank.com/challenges/apple-and-orange/problem
...
public class Solution {
    ...
    static String count(int startPoint, int endPoint, int treeLocation, int[] fruitsLoc){
        int counter=0;
        for(int i=0; i<fruitsLoc.length; i++){
            int fruitLoc=treeLocation+fruitsLoc[i];
            if(fruitLoc>=startPoint && fruitLoc<= endPoint){
                counter+=1;
            }
        }
        return counter+"";
